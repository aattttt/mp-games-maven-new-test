...
public interface Matrix<T> extends Cloneable {
  ...
  /**
   * Convert an object to a string. Intended as an alternate to obj.toString()
   * because
   * obj.toString() doesn't work if obj is null.
   *
   ...
   *
   * @param pen       What we use for printing.
   ...
   * @param cellWidth The width of the box.
   */
   ...
   * @param pen           The PrintWriter to use for printing.
   * @param matrix        The matrix to print.
   * @param includeLabels Set to true if you want labels and false otherwise.
   */
  public static <T> void print(PrintWriter pen, Matrix<T> matrix, boolean includeLabels) {
   ...
   *
   * @param other The object to which we compare ourselves.
   *
